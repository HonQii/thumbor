...
## Video gif auto WebP
FFMPEG_GIF_AUTO_WEBP = {{ FFMPEG_GIF_AUTO_WEBP | default(True) }}
FFMPEG_HANDLE_ANIMATED_GIF = {{ FFMPEG_HANDLE_ANIMATED_GIF | default(False) }}

## Specifies whether WebP format should be used automatically if the request
## accepts it (via Accept header)
## Defaults to: False
AUTO_WEBP = {{ AUTO_WEBP | default(True) }}
...
## https://thumbor-video-engine.readthedocs.io/en/latest/configuration.html#image-engine
ENGINE = '{{ ENGINE | default('thumbor_video_engine.engines.video') }}'

IMAGING_ENGINE = '{{ IMAGING_ENGINE | default('thumbor.engines.pil') }}'

FFMPEG_ENGINE = '{{ FFMPEG_ENGINE | default('thumbor_video_engine.engines.ffmpeg') }}'
...
FFPROBE_PATH = '{{ FFPROBE_PATH  | default('/usr/bin/ffprobe') }}'
################################################################################
...
## https://thumbor-video-engine.readthedocs.io/en/latest/configuration.html#example-configuration
## FFMPEG_H264_MAXRATE = '{{ FFMPEG_H264_MAXRATE | default('1200k') }}'
## FFMPEG_H264_BUFSIZE = '{{ FFMPEG_H264_BUFSIZE | default('2400k') }}'
## FFMPEG_H264_CRF = {{ FFMPEG_H264_CRF | default(24) }}
## FFMPEG_H265_MAXRATE = {{ FFMPEG_H265_MAXRATE | default(1500) }}
## FFMPEG_H265_BUFSIZE = {{ FFMPEG_H265_BUFSIZE | default('3000') }}
## FFMPEG_H265_CRF = {{ FFMPEG_H265_CRF | default(28) }}
## FFMPEG_VP9_VBR = '{{ FFMPEG_VP9_VBR | default('2M') }}'
## FFMPEG_VP9_CRF = {{ FFMPEG_VP9_CRF | default(30) }}
## FFMPEG_VP9_MINRATE = '{{ FFMPEG_VP9_MINRATE | default('1500k') }}'
## FFMPEG_VP9_MAXRATE = '{{ FFMPEG_VP9_MAXRATE | default('2500k') }}'
## FFMPEG_VP9_CPU_USED = {{ FFMPEG_VP9_CPU_USED | default(2) }}
## FFMPEG_VP9_ROW_MT = {{ FFMPEG_VP9_ROW_MT | default(True) }}
## FFMPEG_WEBP_COMPRESSION_LEVEL = {{ FFMPEG_WEBP_COMPRESSION_LEVEL | default(3) }}
## FFMPEG_WEBP_QSCALE = {{ FFMPEG_WEBP_QSCALE | default(80) }}
